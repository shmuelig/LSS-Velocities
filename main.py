...
get_matter_pk = True
get_line_pk = True
get_velocity_pk = True
get_velocity_lim_pk = True
get_electron_lim_pk = True
...
model_data = dict(\
    ...
    bv=1.,
    Acip = 0.,
    bT_up = False, # Added in case of calculating the power spectra derivative w.r.t parameter b_lim*<T> 
    bT_down = False,

    )

survey = 'COS3' # EOR, deep, wide
redshift = 3.5 # 2.6, 3, 5.3, 6.25, 7.25
